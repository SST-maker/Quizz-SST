...
const CACHE_NAME = 'ncr-sst-cache-v3';
const APP_SHELL = [
  './',
  './index.html',
  './quizz.html',
  ...
  './modules/brulures.json',
  './modules/plaies.json',
  './modules/etouffement.json',
  './modules/traumatismes.json',
  './modules/alerte.json',
  './modules/hemorragie.json',
  './modules/perte_connaissance.json',
  './modules/arret_cardiaque.json',
  './modules/malaise.json',
  './modules/protection.json',
  './modules/prevention.json',
  './modules/electrisation.json',
  './favicon.png',
  './logo.png',
  './qrcode.png'
];
